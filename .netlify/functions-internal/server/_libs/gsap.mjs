      ...
      if (specialProp) {
        ...
        if (isTransformRelated) {
          ...
          if (!transformPropTween) {
            ...
            transformPropTween = this._pt = new PropTween(this._pt, style, _transformProp$2, 0, 1, cache.renderTransform, cache, 0, -1);
...
var gsap$2, _coreInitted$1, _win$2, _doc$2, _docEl$1, _body$3, _isTouch, _pointerType, ScrollTrigger$1, _root$1, _normalizer$1, _eventTypes, _context$1, _getGSAP$1 = function _getGSAP() {
  ...
  sc: _scrollCacheFunc(function(value) {
    return arguments.length ? _win$2.scrollTo(value, _vertical.sc()) : _win$2.pageXOffset || _doc$2[_scrollLeft] || _docEl$1[_scrollLeft] || _body$3[_scrollLeft] || 0;
  })
}, _vertical = {
  s: _scrollTop,
  p: "top",
  ...
  op: _horizontal,
  sc: _scrollCacheFunc(function(value) {
    return arguments.length ? _win$2.scrollTo(_horizontal.sc(), value) : _win$2.pageYOffset || _doc$2[_scrollTop] || _docEl$1[_scrollTop] || _body$3[_scrollTop] || 0;
  })
  ...
  if (!_coreInitted$1 && gsap$2 && typeof document !== "undefined" && document.body) {
    ...
    _body$3 = _doc$2.body;
    _root$1 = [_win$2, _doc$2, _docEl$1, _body$3];
    gsap$2.utils.clamp;
...
var gsap$1, _coreInitted, _win$1, _doc$1, _docEl, _body$2, _root, _resizeDelay, _toArray$1, _clamp2, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp$1, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites, _ignoreResize, _normalizer, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context, _scrollRestoration, _div100vh, _100vh, _isReverted, _clampingMax, _limitCallbacks, _startup = 1, _getTime = Date.now, _time1 = _getTime(), _lastScrollTime = 0, _enabled = 0, _parseClamp = function _parseClamp2(value, type, self) {
  ...
  return (dimensionProperty === "Height" ? _100vh : _win$1["inner" + dimensionProperty]) || _docEl["client" + dimensionProperty] || _body$2["client" + dimensionProperty];
  ...
  return Math.max(0, (s = "scroll" + d2) && (a = _getProxyProp(element, s)) ? a() - _getBoundsFunc(element)()[d] : _isViewport2(element) ? (_docEl[s] || _body$2[s]) - _getViewportDimension(d2) : element[s] - element["offset" + d2]);
  ...
  if (!_normalizer || !_normalizer.isPressed || _normalizer.startX > _body$2.clientWidth) {
    _scrollers.cache++;
    if (_normalizer) {
  ...
  _body$2 = _doc$1.body;
  _root = [_win$1, _doc$1, _docEl, _body$2];
  ...
  if (!_isNumber2(value)) {
    ...
    element = _getTarget(trigger, self) || _body$2;
  ...
  if (marker) {
    ...
    _positionMarker(marker, position, direction, isStart && position > 20 || !isStart && (useFixedPosition ? Math.max(_body$2[p1], _docEl[p1]) : marker.parentNode[p1]) <= position + 1);
    if (useFixedPosition) {
...
var ScrollTrigger = /* @__PURE__ */ (function() {
  ...
  _proto.init = function init4(vars, animation) {
    ...
    if (snap3) {
      ...
      "scrollBehavior" in _body$2.style && gsap$1.set(isViewport ? [_body$2, _docEl] : scroller, {
        scrollBehavior: "auto"
      });
    ...
    if (markers) {
      ...
      if (!useFixedPosition && !(_proxies.length && _getProxyProp(scroller, "fixedMarkers") === true)) {
        _makePositionable(isViewport ? _body$2 : scroller);
    ...
    self.refresh = function(soft, force, position, pinOffset) {
      ...
      if (pin && !(_clampingMax && self.end >= _maxScroll(scroller, direction))) {
        ...
        if (!max && end > 1) {
          ...
          if (isViewport && _getComputedStyle(_body$2)["overflow" + direction.a.toUpperCase()] !== "scroll") {
          ...
          if (!useFixedPosition) {
            ...
            if (pinReparent) {
              if (!reset && (isActive || isAtMax)) {
                ...
                _reparent(pin, _body$2, bounds.top + (direction === _vertical ? _offset : 0) + _px, bounds.left + (direction === _vertical ? 0 : _offset) + _px);
              } else {
  ...
  ScrollTrigger2.disable = function disable(reset, kill) {
    ...
    _removeListener2(_body$2, "touchstart", _passThrough2);
  ...
  ScrollTrigger2.enable = function enable() {
    ...
    if (gsap$1) {
      ...
      if (_body$2) {
        ...
        var bodyHasStyle = _body$2.hasAttribute("style"), bodyStyle = _body$2.style, border = bodyStyle.borderTopStyle, AnimationProto = gsap$1.core.Animation.prototype, bounds, i;
        ...
        bounds = _getBounds(_body$2);
        _vertical.m = Math.round(bounds.top + _vertical.sc()) || 0;
        _horizontal.m = Math.round(bounds.left + _horizontal.sc()) || 0;
        border ? bodyStyle.borderTopStyle = border : bodyStyle.removeProperty("border-top-style");
        if (!bodyHasStyle) {
          _body$2.setAttribute("style", "");
          _body$2.removeAttribute("style");
        }
        ...
        _addListener2(_body$2, "touchstart", _passThrough2);
  ...
  ScrollTrigger2.scrollerProxy = function scrollerProxy(target, vars) {
    ...
    if (vars) {
      isViewport ? _proxies.unshift(_win$1, vars, _body$2, vars, _docEl, vars) : _proxies.unshift(t, vars);
    }
  };
...
var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier2(scrollFunc, current, end, max) {
  ...
  target === _docEl && _allowNativePanning2(_body$2, direction);
}, _overflow = {
  auto: 1,
  scroll: 1
  ...
  if (!cache._isScrollT || time - cache._isScrollT > 2e3) {
    while (node && node !== _body$2 && (node.scrollHeight <= node.clientHeight && node.scrollWidth <= node.clientWidth || !(_overflow[(cs = _getComputedStyle(node)).overflowY] || _overflow[cs.overflowX]))) {
