...
function HiOutlineClock(props) {
  return GenIcon({ "attr": { "fill": "none", "viewBox": "0 0 24 24", "strokeWidth": "1.5", "stroke": "currentColor", "aria-hidden": "true" }, "child": [{ "tag": "path", "attr": { "strokeLinecap": "round", "strokeLinejoin": "round", "d": "M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" }, "child": [] }] })(props);
}
...
export {
  HiOutlineCalendarDays as H,
  HiOutlineClock as a,
  HiOutlineBuildingOffice2 as b,
  HiOutlineMapPin as c,
  HiOutlineSpeakerXMark as d,
  HiOutlineSpeakerWave as e
};
